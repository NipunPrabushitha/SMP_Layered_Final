...
import lk.SMP.DAO.custom.impl.SalaryDAOImpl;
...
public class SalaryFormController {
    ...
    private void loadAllCustomer() {
        ...
        try {
            List<Salary> salaryList = new SalaryDAOImpl().getAll();
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        try {
            boolean isDelete = new SalaryDAOImpl().delete(salaryId);
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        try {
           boolean isSaved = new SalaryDAOImpl().save(salary);
            if (isSaved){
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        try {
            ...
            boolean isUpdate = new SalaryDAOImpl().update(salary);
    ...
    private void setEmployeeId(){
        ...
        try {
            String fieldId = new EmployeeDAOImpl().getId(employeeName);
    ...
    private void getEmployeeName(){
        ...
        try {
            List<String> idList = new EmployeeDAOImpl().getEmployeedName();
